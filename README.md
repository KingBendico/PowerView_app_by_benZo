...
For a dual-rail shade, choose **Top rail** or **Bottom rail** beneath the preview. One labelled grip highlights the selected edge; dragging, numeric entry, arrow keys, nudges and presets control that rail. Selecting a rail sends no movement. Unavailable rails explain which rail to move first. **Open shade / Close shade / Stop** control the whole shade.
