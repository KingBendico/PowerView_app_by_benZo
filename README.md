...
- customize the Home dashboard card order, including Whole home, Favorite scenes, Saved controls, Pinned shades, and Your rooms, with drag-and-drop or keyboard move controls saved per gateway;
